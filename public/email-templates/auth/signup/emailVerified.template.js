				...
				<tr>
					<td class="pad">
						<div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
							...
							<p style="margin: 0; margin-bottom: 0px;">You can now log in using your email address and password and make your first or subsequent course order via the following URL</p>
							<p style="margin: 0; margin-bottom: 0px;">&nbsp;</p>
                            <a href="https://academylink.com/shop" style="margin: 0; margin-bottom: 0px;">
                              academylink.com/shop
                            </a>
							<p style="margin: 0; margin-bottom: 0px;">&nbsp;</p>
